  ...
  return (
    <div className="flex w-full flex-col">
      <div className="mb-12 flex flex-col">
        <p className="mb-2 font-dm text-[13px] font-semibold uppercase tracking-[0.2em] text-[var(--pres-accent)]">
          Step 05
        </p>
        <h2 className="max-w-3xl font-display text-3xl font-semibold leading-tight sm:text-4xl md:text-[52px]">
      ...
      <div className="flex flex-col gap-12 md:flex-row md:items-center lg:gap-24">
        {/* Left Side: Diagram */}
        <div className="relative w-full max-w-[360px] flex-shrink-0 sm:max-w-[400px]">
          <svg
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="w-full max-w-lg border border-[var(--pres-border)] border-l-4 border-l-[var(--pres-accent)] bg-[var(--pres-card)] px-6 py-5 shadow-sm sm:px-8 sm:py-6 transition-transform hover:translate-x-1">
